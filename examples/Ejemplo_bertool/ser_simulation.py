...
# Generated: Wed Feb 20 19:45:51 2019
##################################################
...
from SERTool_Channel import SERTool_Channel  # grc-generated hier_block
...
class ser_simulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.SERTool_Channel_1 = SERTool_Channel(
            B=samp_rate,
            EsN0max=EsN0max,
            EsN0min=EsN0min,
            N_snr=N_snr,
        ...
        self.top_grid_layout.addWidget(self.SERTool_Channel_1)
        ...
        # Connections
        ##################################################
        self.connect((self.SERTool_Channel_1, 0), (self.digital_constellation_decoder_cb_0, 0))
        self.connect((self.analog_random_source_x, 0), (self.blocks_throttle, 0))
        self.connect((self.blocks_throttle, 0), (self.SERTool_Channel_1, 1))
        self.connect((self.blocks_throttle, 0), (self.digital_chunks_to_symbols_xx, 0))
        self.connect((self.digital_chunks_to_symbols_xx, 0), (self.SERTool_Channel_1, 0))
        self.connect((self.digital_constellation_decoder_cb_0, 0), (self.SERTool_Channel_1, 2))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.SERTool_Channel_1.set_B(self.samp_rate)
    ...
    def set_Rs(self, Rs):
        self.Rs = Rs
        self.SERTool_Channel_1.set_Rs(self.Rs)
    ...
    def set_N_snr(self, N_snr):
        self.N_snr = N_snr
        self.SERTool_Channel_1.set_N_snr(self.N_snr)
    ...
    def set_EsN0min(self, EsN0min):
        ...
        self.SERTool_Channel_1.set_EsN0min(self.EsN0min)
    ...
    def set_EsN0max(self, EsN0max):
        ...
        self.SERTool_Channel_1.set_EsN0max(self.EsN0max)
